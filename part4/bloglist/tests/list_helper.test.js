...
describe('mostBlogs', () => {
    ...
    test('when list has only one blog, returns {author: thats author, blogs: 1}', () => {
...
describe('mostLikes', () => {
    test('of empty list is {author: null, likes: 0}', () => {
        const result = listHelper.mostLikes([]);

        assert.deepStrictEqual(result, { author: null, likes: 0 });
    });

    test('when list has only one blog, returns {author: thats author, likes: thats likes}', () => {
